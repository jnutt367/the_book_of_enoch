  ...
  return (
    <main className="flex min-h-screen flex-col gap-5 items-center justify-between p-24 pl-2 pr-2">
      <div className="z-10 ml-10 mb-5 w-full max-w-5xl items-center justify-between font-mono text-sm lg:flex">
        <p className="fixed pb-0 left-0 top-1 right-1 flex w-full justify-center border-b border-gray-300 bg-gradient-to-b from-zinc-200 pb-6 pt-8 pr-20 backdrop-blur-2xl dark:border-neutral-800 dark:bg-zinc-800/30 dark:from-inherit lg:static lg:w-auto  lg:rounded-xl lg:border lg:bg-gray-200 lg:p-4 lg:dark:bg-zinc-800/30">
       ENOCH&nbsp;
      ...
      <div className="mb-32 grid text-center lg:mb-0 lg:w-full lg:max-w-5xl lg:grid-cols-4 lg:text-left">
        <a
          ...
          className="group rounded-lg border border-transparent pr-0 px-5 py-4 transition-colors hover:border-gray-300 hover:bg-gray-100 hover:dark:border-neutral-700 hover:dark:bg-neutral-800/30"
          target="_blank"
        ...
        <a
          ...
          className="group rounded-lg border border-transparent pr-2 px-5 py-4 transition-colors hover:border-gray-300 hover:bg-gray-100 hover:dark:border-neutral-700 hover:dark:bg-neutral-800/30"
          target="_blank"
          rel="noopener noreferrer"
        >
          <h2 className="mb-3 text-2xl font-semibold">
        ...
        >
          ...
          <p className="m-0 max-w-[30ch] text-balance pl-10 pr-2 text-sm opacity-50">
